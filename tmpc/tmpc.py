...
class Parameters:
    def __init__(self, origin, spheroid):
        ...
        A0 = 1.0 - self.e2 / 4.0 - 3.0 * self.e4 / 64.0 - 5.0 * self.e6 / 256.0
        A2 = 3.0 / 8.0 * (self.e2 + self.e4 / 4.0 + 15.0 * self.e6 / 128.0)
        A4 = 15.0 / 256.0 * (self.e4 + 3.0 * self.e6 / 4.0)
        A6 = 35.0 * self.e6 / 3072.0
